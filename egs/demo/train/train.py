...
if __name__ == '__main__':
    ...
    #changed input channels to be 12 (6*2)
    model = UNet(kc=args.kc, inc=args.inch*2, ouc=args.inch).to(device)
    ...
    test_dataloader1  = torch.utils.data.DataLoader(dataset=test_dataset1,  batch_size=500, shuffle=True,  num_workers=0, drop_last=False)
    test_dataloader2  = torch.utils.data.DataLoader(dataset=test_dataset2,  batch_size=500, shuffle=True,  num_workers=0, drop_last=False)
    test_dataloader3  = torch.utils.data.DataLoader(dataset=test_dataset3,  batch_size=500, shuffle=True,  num_workers=0, drop_last=False)
    test_dataloader4  = torch.utils.data.DataLoader(dataset=test_dataset4,  batch_size=500, shuffle=True,  num_workers=0, drop_last=False)
